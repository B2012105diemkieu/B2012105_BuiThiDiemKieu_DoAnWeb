<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/admin" class="logo"><img src="../assets/images/Style_small.jpg" alt="" />Giày Style
        </router-link>
        ...
        <div class="icons">
         <div  class="fas fa-user account" style="background: #f38609;color: white;" @click="showLog">
            ...
            <ul class="drop-down-select">
                        <router-link @click="handleLogout"  to="/admin">Đăng xuất</router-link>
