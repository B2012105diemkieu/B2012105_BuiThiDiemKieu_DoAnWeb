            ...
            <div class="wrapper wrapper-content">
                <div class="row">
                    <div class="in-cart col-md-9">
                        <div class="box">
                            ...
                            <div v-if="!filterFoods.length">
                                <div class="box-content row no-food">
                                    <div class="content">
                                        <h2 style="color: #057835fa;">Chưa có mặt hàng trong giỏ hàng, hãy mua ngay!!!
                                            </h2>
                                    </div>
                                    <div class="image">
                                        <img src="../assets/images/Style2_home.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                            <div v-else>
                        ...
                        <div class="box-content row">
                            <router-link to="/product" class="btn shop-btn"><i class="fa fa-arrow-left"></i>Tiếp tục mua hàng</router-link>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i> +84 458 147 264</h3>
                                <span class="small">
                                    Hãy liên hệ với chúng tôi khi bạn có bất kỳ câu hỏi nào. Chúng tôi sẽ nhanh chóng trả lời bạn.
                                </span>
                            </div>
                        </div>
                    </div>
