    ...
    <section class="order-section">
        ...
        <div class="icons-container">
            ...
            <div class="icons ">
                ...
                <h3>7:00am đến 10:00pm</h3>
            </div>

            <div class="icons">
                <img src="../assets/images/icon-2.png" alt="">
                <h3>+84 458 147 264</h3>
            </div>

            <div class="icons">
                <img src="../assets/images/icon-3.png" alt="">
                <h3>Xuân Khánh, Ninh Kiều, TP.Cần Thơ</h3>
            </div>
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            ...
            <div class="row">
                <div class="input-box">
                    <label for="oPeople">Địa chỉ</label>
...
--> 
            <div class="row">
                <div class="input-box">
                    <label for="uMessage">Câu hỏi</label>
                    <textarea placeholder="your message" name="uMessage"
                        id="uMessage" cols="30" rows="10" v-model="orderObj.note"></textarea>
                </div>
               <!--<div class="input-box">
                    <iframe class="map"
                        
                        src="https://maps.app.goo.gl/sUDp7uv6pBfzCBL36"
                        loading="lazy"></iframe>
                </div>
                --> 
