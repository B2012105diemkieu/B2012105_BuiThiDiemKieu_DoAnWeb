    ...
    <div>
        <div class="home-main">
            <div class="content">
                ...
                <h3>Tiệm giày Style</h3>
                <p>Chúng tôi cung cấp đa dạng các loại giày cho nam và nữ chất lượng với nhiều sự lựa chọn và giá thành phù hợp.</p>
                <router-link @click="scrollToTop()" to="/product" class="btn">Đặt hàng ngay</router-link>
            </div>
            <div class="image">
                <img src="../assets/images/Style2_home.jpg" alt="" class="home-img">
        ...
        <div class="home-category">
            <router-link @click="scrollToTop()" to="/product" class="box">
                <img src="../assets/images/giaythethaonu1.jpg" alt="">
                <h3>Giày thể thao nữ</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/product" class="box">
            <img src="../assets/images/giaycaogot1.jpg" alt="">
                <h3>Giày cao gót nữ</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/product" class="box">
                <img src="../assets/images/bootnu1.jpeg" alt="">
                <h3>Boot nữ</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/product" class="box">
                <img src="../assets/images/giaybupbenu1.jpg" alt="">
                <h3>Giày búp bê nữ</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/product" class="box">
                <img src="../assets/images/giaythethaonam1.png" alt="">
                <h3>Giày thể thao nam</h3>
            </router-link>

            <router-link @click="scrollToTop()" to="/product" class="box">
                <img src="../assets/images/giaytaynam1.jpg" alt="">
                <h3>Giày tây nam</h3>
            </router-link>
        </div>
        ...
        <div class="home-banner">
            <div class="grid-banner row">
                ...
                <div class="grid col-md-4">
                    <img src="../assets/images/giaycaogotnu2.jpg" alt="">
                ...
                <div class="grid col-md-4">
                    <img src="../assets/images/giaytaynam2.jpg" alt="">
                    <div class="content">
                        <span>Khuyến mãi đặc biệt</span>
                        <h3>FREE Ship TP.Cần Thơ</h3>
                        <router-link @click="scrollToTop()" to="/product" class="btn">Đặt hàng ngay</router-link>
                    </div>
                </div>
        ...
        <div class="home-about">
            <div class="image">
                <img src="../assets/images/kegiay1.jpg" alt="">
            </div>
            <div class="content">
                <span>Tại sao lựa chọn cửa hàng Style?</span>
                <h3 class="title">Bằng cách nào chúng tôi thu hút khách hàng</h3>
                <p>Sản phẩm của cửa hàng luôn đảm bảo chất lượng, đa dạng mẫu và giá tiền phù hợp. Nhân viên luôn tư vấn, giải đáp 
                    tất cả thắc mắc của khách hàng, được đổi size nếu không vừa. Tất cả các sản phẩm mua từ cửa hàng đều được bảo hành 6 tháng.</p>
                <router-link @click="scrollToTop()" to="/about" class="btn">Đọc thêm</router-link>

                <div class="icons-container">
                    <div class="icons">
                        <img src="../assets/images/Style_small.jpg" alt="">
                        <h3>Đa dạng mẫu</h3>
                    </div>
                    <div class="icons">
...
.home-banner .row-banner {
    background: url(../assets/images/Style1_home.jpg) no-repeat;
    height: 45rem;
